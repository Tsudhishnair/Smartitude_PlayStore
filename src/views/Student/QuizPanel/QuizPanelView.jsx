...
class QuizPanelView extends React.Component {
    ...
    handleTabSwitchSubmission = () => {
        ...
        console.log("Reached intermediate level");
        if (this.quizTabSwitchCounter == 2) {
            console.log("Reached intermediate level 1 if counter =2 ");
            return (
                <MessageDialog
            ...
            console.log("Reached intermediate level 1 if counter =0/345 " + this.quizTabSwitchCounter);
            return (
                <MessageDialog
    ...
    handleVisibilityChange = () => {
        ...
        if (document[this.browserStatus]) {
            this.handleTabSwitchSubmission();
        }
    };
