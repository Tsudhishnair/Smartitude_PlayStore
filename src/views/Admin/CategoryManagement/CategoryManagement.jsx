    ...
    return (
      <React.Fragment>
        ...
        <Card>
          <List
            component="nav"
            subheader={<ListSubheader component="div">Catagories</ListSubheader>}
          ...
          >
            ...
            <ListItem button onClick={this.handleClick}>
              ...
              <ListItemText inset primary="Catagories 1" />
            ...
            <Collapse in={this.state.open} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                <ListItem button className={classes.nested}>
                  ...
                  <ListItemText inset primary="Sub-Catagories 1" />
                </ListItem>
                <ListItem button className={classes.nested}>
                  <ListItemIcon>
                    <StarBorder />
                  ...
                  <ListItemText inset primary="Sub-Catagories 1" />
                </ListItem>                <ListItem button className={classes.nested}>
                  <ListItemIcon>
                    <StarBorder />
                  </ListItemIcon>
                  <ListItemText inset primary="Sub-Catagories 1" />
