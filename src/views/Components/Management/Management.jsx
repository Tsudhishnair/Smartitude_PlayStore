...
class EnhancedTable extends React.Component {
  state = {
    ...
    selected: [],
    data: [
      createData('Sudhish', 'Faculty', 'Quantitative', 67, 'uxxxxx'),
      createData('Ramesh', 'Faculty', 'Quantitative', 51, 'uxxxxx'),
      createData('Prejith', 'Faculty', 'Quantitative', 24, 'uxxxxx'),
      createData('Prabha', 'Incharge', 'NA', 24, 'uxxxxx'),
      createData('Sumesh', 'Faculty', 'Quantitative', 49, 'uxxxxx'),
      createData('Mebin', 'Faculty', 'Algebra', 87, 'uxxxxx'),
      createData('sudhish', 'Faculty', 'Algebra', 37, 'uxxxxx'),
      createData('Varun', 'Faculty', 'Quantitative', 94, 'uxxxxx'),
      createData('Anil', 'Faculty', 'Motion', 65, 'uxxxxx'),
      createData('Sashi', 'Faculty', 'Algebra', 98, 'uxxxxx'),
      createData('Ravi', 'Incharge', 'NA', 81, 'uxxxxx'),
      createData('Sunny', 'Faculty', 'Algebra', 9, 'uxxxxx'),
      createData('Mia K', 'Incharge', 'NA', 63, 'uxxxxx'),
    ],
    page: 0,
    rowsPerPage: 10,
  };
